...
company_data = pd.read_excel("https://github.com/adisat8024/stock-price-prediction/raw/main/tickers.xlsx")
...
def get_stock_data(ticker_symbol, year_list):
    try:
        ...
        yearly_data = yearly_data.resample('A').agg({"High": "max", "Low": "min", "Open": "first", "Close": "last"})
